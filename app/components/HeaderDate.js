		...
		return (
			<View
				style={[
					...
					{ backgroundColor: this.props.background || Colors.primary }
				]}>
				{this._backButton()}
				<Text style={[DefaultStyle.default_text, styles.day_text]}>
					{date.format('dddd')}
				</Text>
				<Text style={[DefaultStyle.default_text, styles.date_text]}>
					{date.format('DD')}
				</Text>
			</View>
		)
