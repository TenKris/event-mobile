        ...
        if (this.state.renderToast) {
            return (
                <Animated.View
                    ...
                    <TouchableOpacity onPress={() => this.hide()} activeOpacity={.85}>
                        <View style={[styles.toastContainer, { backgroundColor: this.backgroundColor || "#333" }]}>
                            <Text
                                numberOfLines={1}
                                style={styles.text}>{this.message}</Text>
                        </View>
                    </TouchableOpacity>
                </Animated.View>
            );
